...
allowed_domains='localhost|127\.0\.0\.1|example\.com|your-site\.example|workers\.dev|cloudflare\.com|github\.com|npmjs\.org|senate\.gov|congress\.gov|api\.congress\.gov|govinfo\.gov|googleapis\.com|opencollective\.com|tidelift\.com|vitejs\.dev|paper\.design'
filtered="$(
