...
- Fix timeline: prioritized by severity and exploitability

## Supported Versions

This project follows a rolling release model on `main`. Security fixes will be applied to current `main`.
