...
describe('Home', () => {
  it('renders the feed as a list with visible outcomes and no flip hints', async () => {
    ...
    expect(screen.getByText('Full House election — all 435 seats on the November 2026 ballot')).toBeInTheDocument()
    expect(screen.getByText('33 Senate seats on the November 2026 ballot')).toBeInTheDocument()
