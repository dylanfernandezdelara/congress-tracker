...
- **Rust CLI** (`src/`): Reference implementation for Senate XML parsing and validation
- **Cloudflare Worker** (`workers/senate_data_worker/`): Production ingestion and API service
