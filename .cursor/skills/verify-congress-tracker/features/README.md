...
- [Ask about this bill](./bill-chat.md) covers the grounded chat docked on the desktop right rail (or a mobile bottom drawer): starter chips, Open in ▾ (ChatGPT / Claude), streamed answers with verbatim quoted passages, `Ask about this` selection attachments, and `Share this passage`.
