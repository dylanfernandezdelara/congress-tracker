...
- [Ask about this bill](./bill-chat.md) covers the grounded chat at the bottom of the detail panel: starter chips, Open in ▾ (ChatGPT / Claude), streamed answers with verbatim quoted passages, `Ask about this` selection attachments, and `Share this passage`.
