...
- Tap **Continue in…** → **Open in ChatGPT** or **Open in Claude** to continue in those apps.
...
- **Continue in…** `./.cursor/skills/verify-congress-tracker/bin/verify-congress-tracker browser click --role button --name "Continue this bill in ChatGPT or Claude"` then `./.cursor/skills/verify-congress-tracker/bin/verify-congress-tracker browser find --role menuitem --name "/Open in ChatGPT/"` and `./.cursor/skills/verify-congress-tracker/bin/verify-congress-tracker browser find --role menuitem --name "/Open in Claude/"`. `./.cursor/skills/verify-congress-tracker/bin/verify-congress-tracker browser eval --js "document.querySelector('[role=menuitem][href*=chatgpt]').href.includes('prompt=')"` is true. Press Escape to close the menu.
