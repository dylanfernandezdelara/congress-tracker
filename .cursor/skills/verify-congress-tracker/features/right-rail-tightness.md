...
- `tightness-mobile` stacks House and Senate bars after the chronological feed; the Senate group stays visible.
...
- On a phone-width viewport, read the timeline first, then margin bars, then Senate-waiting.
